...
const BADGE = {
    ...
    metre: 'bg-blue-100 text-blue-700',
    camarero: 'bg-sky-100 text-sky-700',
    jefe_cocina: 'bg-orange-100 text-orange-700',
    cocinero: 'bg-amber-100 text-amber-700',
        ...
        >
            ...
            <div className="py-8">
                <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    {/* Flash de éxito */}
                    {/* Inertia pasa el flash via usePage, pero si lo manejas en el layout ya aparece */}
                                ...
                                {usuarios.data.map((usuario) => {
                                    ...
                                    return (
                                        <tr key={usuario.id} className="border-t hover:bg-gray-50">
                                            <td className="p-4 font-mono text-sm font-medium text-gray-800">
                                                {usuario.name}
                                            </td>
                                                ...
                                                {auth.user.role === 'admin' && (
                                                    <>
                                                        ...
                                                        {usuario.id !== auth.user.id && (
                                                            <button
                                                                onClick={() => eliminar(usuario.id, usuario.name)}
